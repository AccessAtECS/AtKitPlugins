(function(){
	...
	var plugin = function(){
		...
		AtKit.addFn('sendTTSChunk', function(args){
			...
			var urlString = settings.serverURL + 'xmlhttp/remote.php?rt=tts&v=2&h=1&id=' + args.reqID + '&data=' + payload + "&chunkData=" + args.totalBlocks + "-" + args.block;
